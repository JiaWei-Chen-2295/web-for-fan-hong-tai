...
export const SceneIntro: React.FC<TransitionProps> = ({ onNext, isActive }) => {
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-between py-10 px-6 overflow-hidden">
      ...
      <motion.div 
        animate={{ opacity: [0.5, 0.8, 0.5], rotate: [0, 5, -5, 0] }}
        transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
        className="absolute inset-0 bg-gradient-to-b from-[#4c1d95] via-[#f97316] to-[#fbbf24] opacity-90 z-0" 
      />
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/noise.png')] opacity-20 z-0 pointer-events-none mix-blend-overlay" />
      ...
      >
        <div className="border-[8px] border-[#1a1a1a] relative shadow-2xl rounded-sm overflow-hidden">
            ...
            <div className="bg-[#fff9f0] relative p-1 min-h-[460px] flex flex-col">
                {/* Ticket Image */}
                <div className="h-44 w-full bg-cover bg-center grayscale-[0.2] sepia-[0.3] relative" 
                     style={{ backgroundImage: "url('https://images.unsplash.com/photo-1459749411177-0473ef4884f3?q=80&w=2070&auto=format&fit=crop')" }}>
                ...
                <div className="px-6 py-4 text-center flex-1 flex flex-col justify-center">
                    ...
                    <div className="grid grid-cols-3 border-y border-slate-200 py-4 mb-2">
                        ...
                        <div className="text-center border-x border-slate-200">
                            ...
                            <p className="text-xs font-bold text-dusk-dark">Jiawei</p>
                        </div>
                        <div className="text-center">
